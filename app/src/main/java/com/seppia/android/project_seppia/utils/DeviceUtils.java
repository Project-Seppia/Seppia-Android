...
public final class DeviceUtils {
	...
	public static String getPackageName(){
		try{
			return Settings.GLOBAL_CONTEXT.getPackageName();
		}catch(Exception e){
			return "";
		}
	}
	 ...
	 * getPathByUri(this, data.getResult()); }
	 * 
	 * @param activity
	 * @param requestCode
	 */
	 ...
	 * @param placeTitle
	 */
	public static void callMap(Activity activity, String address,
	 ...
	 */
	public static void callShare(Activity activity, String subject,
	 ...
	 * @param body
	 */
	public static void callEmail(Activity activity, String address,
	...
	public static void delShortcut(Context context) {
		try {
			...
			intentDelshortcut.putExtra(Intent.EXTRA_SHORTCUT_INTENT,
					intentShortcut);
			intentDelshortcut.putExtra(Intent.EXTRA_SHORTCUT_NAME,
					getAppName(context));
